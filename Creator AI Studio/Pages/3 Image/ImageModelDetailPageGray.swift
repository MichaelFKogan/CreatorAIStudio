// //
// //  ImageModelDetailPageGray.swift
// //  Creator AI Studio
// //
...
// struct ImageModelDetailPageGray: View {
...
//                     .opacity(0.9)
//                     .padding(8) // ← real internal padding
//                     .focused($isFocused)
...
//                         .padding(.horizontal, 16) // slightly larger to match TextEditor inset
//                         .padding(.vertical, 16)
