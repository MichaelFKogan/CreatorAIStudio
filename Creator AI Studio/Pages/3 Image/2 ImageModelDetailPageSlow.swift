...
// import SwiftUI
//
// struct ImageModelDetailPageSlow: View {
...
//     @State private var selectedGenerationMode: Int = 0 // 0 = Text to Image, 1 = Image to Image
//
...
//                             // MARK: TAB SWITCHER
//
//                             // Tab Switcher for Text to Image vs Image to Image
//                             HStack(spacing: 0) {
//                                 // Text to Image Tab
//                                 Button(action: {
//                                     withAnimation(.easeInOut(duration: 0.2)) {
//                                         selectedGenerationMode = 0
//                                     }
//                                 }) {
//                                     HStack(spacing: 4) {
...
//                                             .fontWeight(.medium)
//                                     }
//                                     .foregroundColor(selectedGenerationMode == 0 ? .white : .secondary)
...
//                                             .fontWeight(.medium)
//                                     }
//                                     .foregroundColor(selectedGenerationMode == 1 ? .white : .secondary)
//                                     .frame(maxWidth: .infinity)
//                                     .padding(.vertical, 10)
//                                     .background(
//                                         selectedGenerationMode == 1 ?
...
//                             // Only show when Image to Image mode is selected
