//
//  GangnamStyleFilterDetailPage.swift
//  Creator AI Studio
//
...
struct GangnamStyleFilterDetailPage: View {
    ...
    private func generate() {
        ...
        // Set the prompt for Gangnam Style transformation
        ...
        guard let refVideoURL = referenceVideoURL else {
            isGenerating = false
            print("Error: Reference video not found for Gangnam Style filter")
            return
        }
