...
struct TechnoVikingFilterDetailPage: View {
        ...
        GeometryReader { _ in
            ZStack(alignment: .bottom) {
                ScrollView {
                    VStack(spacing: 16) {
                        // Page Title - Animated
                        AnimatedTitle(text: "Techno Viking Dance")
                            .padding(.top, 16)
    ...
    private func getReferenceVideoURL() -> URL? {
        // IMPORTANT: Replace this with your actual Supabase Storage URL after uploading technoVikingReference.mp4
        // Example: "https://your-project-id.supabase.co/storage/v1/object/public/videos/technoVikingReference.mp4"
        let supabaseVideoURL = "https://inaffymocuppuddsewyq.supabase.co/storage/v1/object/public/reference-videos/technoVikingReference.mp4"
