...
struct ResolutionOption: Identifiable {
    let id: String // e.g., "480p", "720p", "1080p"
    let label: String // e.g., "480p", "720p", "1080p"
    let description: String? // Optional description
}

// MARK: RESOLUTION SELECTOR BUTTON
...
// MARK: RESOLUTION SELECTOR SHEET

struct ResolutionSelectorSheet: View {
    let options: [ResolutionOption]
    @Binding var selectedIndex: Int
    let color: Color
