...
struct VideoPricingConfiguration {
    ...
    func price(aspectRatio: String, resolution: String, duration: Double) -> Decimal? {
        ...
        variableVideoPricing = [
            ...
            "Seedance 1.0 Pro Fast": VideoPricingConfiguration(
                pricing: [
                    ...
                    "21:9": [
                        "480p": [5.0: 0.0304, 10.0: 0.0607],
                        "720p": [5.0: 0.0732, 10.0: 0.1464],
                        "1080p": [5.0: 0.1536, 10.0: 0.3072]
                    ]
                ]
            )
        ]
...
// MARK: METHODS
    ...
    /// - Returns: The price as a Decimal, or nil if not found
    func variablePrice(for modelName: String, aspectRatio: String, resolution: String, duration: Double) -> Decimal? {
        guard let config = variableVideoPricing[modelName] else { return nil }
        return config.price(aspectRatio: aspectRatio, resolution: resolution, duration: duration)
    }
...
// MARK: DIMENSIONS??? WHY?
    ...
    static func dimensionsForAspectRatioAndResolution(aspectRatio: String, resolution: String) -> (width: Int, height: Int)? {
